...
function ContactSection({ profileInfo }: HeroSectionProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setNotification({ message: 'Email has sended successfullyy', type: 'success' })
        } catch (error: any) {
            console.error(error?.message || 'Error in sending Email, please try again');
            setNotification({ message: 'Error in sending Email', type: 'error' })
        } finally {
