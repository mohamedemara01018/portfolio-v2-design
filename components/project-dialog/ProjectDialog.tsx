...
function ProjectDialog({ isOpen, isEdit, setOpen, project }: { isOpen: boolean, isEdit: boolean, setOpen: (val: boolean) => void, project: Project }) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (isEdit) {
                ...
                await projectService.updateProject(id!, newFormData);
                setNotification({ message: 'update project success', type: 'success' })
            } else {
                await projectService.createNewProject(newFormData);
